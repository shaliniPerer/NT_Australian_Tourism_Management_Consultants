			...
			<nav className="bg-white border-b border-gray-50 sticky top-0 z-50">
				...
				{isMenuOpen && (
					<div className="md:hidden bg-white border-t p-4 space-y-3">
						<a
							href="#Home"
							className="block w-full text-left text-[#2d4a3e] text-[10px] uppercase tracking-widest"
						>
							HOME
						</a>
						<a
				...
				<div className="max-w-4xl mx-auto text-center relative z-10">
					...
					<div className="space-y-2 relative">
						{[
							...
							<div
								key={index}
								className={`flex flex-col items-center md:flex-row ${item.align === 'right' ? 'md:justify-end' : 'md:justify-start'} mb-8`}
							>
								<div className="relative mb-4 md:mb-0 md:mr-8 md:ml-0">
									...
									{/* Card content */}
									<div className="bg-[#4c9970] backdrop-blur-sm rounded-2xl py-4 px-4 md:py-6 md:pl-16 md:pr-8 w-[90vw] max-w-xs md:w-[320px] min-h-[100px] text-center md:text-left">
										<h3 className="text-lg font-semibold text-[#c7eedd] text-center md:text-left">{item.name}</h3>
										...
										<p className="text-white/80 text-sm leading-relaxed text-center md:text-left">{item.review}</p>
									</div>
								</div>
							</div>
						))}
									...
									<div className="border-t border-white/20 pt-6">
										...
										<ul className="space-y-3 text-sm text-white/80">
											<li className="flex items-center gap-3">
												...
												<span>19 Smith Street, Darwin, Northern Territory 0800</span>
											</li>
											<li className="flex items-center gap-3">
												<svg className="w-5 h-5 flex-shrink-0 text-[#4c9970]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left items-center md:items-start justify-center">
						...
						<div className="flex flex-col items-center md:items-start text-center md:text-left">
							...
							<ul className="space-y-3 text-sm text-white/70">
								...
								<li className="flex flex-col items-center md:flex-row md:items-center gap-3">
				...
				<div className="border-t border-white/10">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
						<div className="flex flex-col md:flex-row justify-center md:justify-between items-center gap-4 text-center">
							<p className="text-white/50 text-sm w-full md:w-auto">
